codeunit 60004 "MyUnplanned Samples"
{
    ...
    var
        ...
        OneMenuLbl: Label 'My Unplanned One', Comment = 'Menu label for MyUnplannedHeaderAndSteps';
        OneTitleLbl: Label 'My Unplanned (Header and Steps)', Comment = 'Page title for MyUnplannedHeaderAndSteps';
        TwoMenuLbl: Label 'My Unplanned Two', Comment = 'Menu label for MyUnplannedOnlyHeader';
        TwoTitleLbl: Label 'My Unplanned (Only Header)', Comment = 'Page title for MyUnplannedOnlyHeader';
        ThreeMenuLbl: Label 'My Unplanned Three', Comment = 'Menu label for MyUnplannedOnlySteps';
        ThreeTitleLbl: Label 'My Unplanned (Only Steps)', Comment = 'Page title for MyUnplannedOnlySteps';
        FourMenuLbl: Label 'My Unplanned Four', Comment = 'Menu label for MyUnplannedOnlyContext';
        FourTitleLbl: Label 'My Unplanned (Only Context)', Comment = 'Page title for MyUnplannedOnlyContext';
    begin
        ...
        Message.Create(LanguageCode, 'MY_UNPLANNED_ONE', OneMenuLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_ONE_TITLE', OneTitleLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_TWO', TwoMenuLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_TWO_TITLE', TwoTitleLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_THREE', ThreeMenuLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_THREE_TITLE', ThreeTitleLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_FOUR', FourMenuLbl);
        Message.Create(LanguageCode, 'MY_UNPLANNED_FOUR_TITLE', FourTitleLbl);
        ...
        case LanguageCode of
            'ENU':
                begin
                    ...
                    Message.Create(LanguageCode, 'MY_UNPLANNED_ONE', 'My Unplanned One');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_ONE_TITLE', 'My Unplanned (Header and Steps)');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_TWO', 'My Unplanned Two');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_TWO_TITLE', 'My Unplanned (Only Header)');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_THREE', 'My Unplanned Three');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_THREE_TITLE', 'My Unplanned (Only Steps)');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_FOUR', 'My Unplanned Four');
                    Message.Create(LanguageCode, 'MY_UNPLANNED_FOUR_TITLE', 'My Unplanned (Only Context)');
                end;
