report 81274 "MOB1D LP Contents Label"
{
    Caption = 'Mobile WMS - License Plate Contents Label (1D)';
    /* #if BC20+ */
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                dataitem("MOB License Plate"; "MOB License Plate")
                {
                    ...
                    begin
                        ...
                        BarcodeManagement1D.SetSimpleTextToEncode("No.");
    ...
    begin
        // Get tracking setup
        Mob1DInternalMobFunctions.CopyTrackingToMobTrackingSetup(_LicensePlateContent, MobTrackingSetup);
