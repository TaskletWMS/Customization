report 6181273 "MOB Item Label"
{
    Caption = 'Mobile WMS - Item Label';
    /* #if BC20+ */
        ...
        dataitem(CopyLoop; "Integer")
        {
            ...
            dataitem(Item; Item)
            {
                ...
                begin
                    ...
                    // Initialize barcode encoder for 2D Data Matrix
                    BarcodeManagement2D.SetAiDictionary(InternalAiDictionary);
                    BarcodeManagement2D.Set_BarcodeFontProvider("Barcode Font Provider 2D"::IDAutomation2D);
                    BarcodeManagement2D.Set_BarcodeSymbology("Barcode Symbology 2D"::"Data Matrix");
                    EncodedBarcodeText := BarcodeManagement2D.GetEncodedBarcodeText(); // Encode Ai values based on local AiDictionary                    
    ...
    rendering
    {
        layout("Item Label 2x1")
        {
            ...
            Summary = 'Mobile WMS - Item Label 2x1 with encoded GS1 2D datamatrix';
        ...
        layout("Item Label 3x2")
        {
            ...
            Summary = 'Mobile WMS - Item Label 3x2 with encoded GS1 2D datamatrix';
        ...
        layout("Item Label 4x1")
        {
            ...
            Summary = 'Mobile WMS - Item Label 4x1 with encoded GS1 2D datamatrix';
        ...
        layout("Item Label 4x2")
        {
            ...
            Summary = 'Mobile WMS - Item Label 4x2 with encoded GS1 2D datamatrix';
        ...
        layout("Item Label 4x3")
        {
            ...
            Summary = 'Mobile WMS - Item Label 4x3 with encoded GS1 2D datamatrix';
        ...
        layout("Item Label 4x6")
        {
            ...
            Summary = 'Mobile WMS - Item Label 4x6 with encoded GS1 2D datamatrix';
    ...
    begin
        ...
        if QuantityReq <> 0 then
            if MobGs1Helper.QuantityTransformedToAI310n(QuantityReq, Ai310n, Ai310Qty) then
